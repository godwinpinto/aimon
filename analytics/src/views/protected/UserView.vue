...
export default {
    ...
    created() {
        ...
        axios.get('/api/user_view') // Replace with your API endpoint URL
            .then(response => {
    ...
    methods: {
        demo() {
            alert("TODO:: This functionality would allow adminstrator to add more records and create access secrets to be inputed in browser setup for AI-MON Extension");
        }
    }
};
</script>
