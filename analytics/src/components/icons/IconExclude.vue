<template>
    <svg fill="none" height="24" stroke-width="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M13.5 15H14.4C14.7314 15 15 14.7314 15 14.4V13.5" stroke="currentColor" stroke-linecap="round"
        ...
        <path
            ...
            stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M9 10.5V9.6C9 9.26863 9.26863 9 9.6 9H10.5" stroke="currentColor" stroke-linecap="round"
            stroke-linejoin="round" />
    </svg>
</template>